...
| 03c | [`03c-not-indexed-urls-2026-09-06.md`](./03c-not-indexed-urls-2026-09-06.md) ✅ | **Working checklist.** Full sweep of all 125 sitemap URLs: **44 are not indexed (35%)**, every one never crawled. Grouped by priority for manual GSC "Request indexing", with a per-section scorecard (`/technology` 65% missing, locations 0%). |
